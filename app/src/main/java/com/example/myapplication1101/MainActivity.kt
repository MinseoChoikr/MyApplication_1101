package com.example.myapplication1101
...
class MainActivity : AppCompatActivity(), ActionBar.TabListener {
    ...
    lateinit var tabJang : ActionBar.Tab
    ...
    class MyTabFragment : androidx.fragment.app.Fragment() {
        ...
        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,  savedInstanceState: Bundle?): View? {
            ...
            if (tabName === "장르별") baseLayout.setBackgroundColor(Color.YELLOW)
